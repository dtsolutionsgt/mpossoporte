...
public class VersionEmpresa extends PBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            setContentView(R.layout.activity_version_empresa);
    ...
    private void listItems() {
        ...
        try {
            ...
            adapter =new LA_Version(this,this,items,false);
    ...
    private void listVersiones(int idemp) {
