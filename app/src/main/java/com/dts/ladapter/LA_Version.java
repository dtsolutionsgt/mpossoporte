...
public class LA_Version extends BaseAdapter {
    ...
    public LA_Version(Context context, PBase owner, ArrayList<clsClasses.clsMenu> results, boolean fflag) {
        items = results;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = l_Inflater.inflate(R.layout.lv_version, null);
        ...
        if (flag) {
            holder.lbl1.setText(""+items.get(position).nombre+" ( "+items.get(position).id+" )");
        } else {
