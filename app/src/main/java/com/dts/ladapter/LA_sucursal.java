...
public class LA_sucursal extends BaseAdapter {
    ...
    public LA_sucursal(Context context, PBase owner, ArrayList<clsClasses.clsSucursal> results) {
        items = results;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.lbl2.setText("");
        holder.lbl3.setText(""+items.get(position).descripcion+" ("+items.get(position).id+")");
