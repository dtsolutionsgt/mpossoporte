...
public class LA_P_paramext_val  extends BaseAdapter {
    ...
    public LA_P_paramext_val(Context context, PBase owner, ArrayList<clsClasses.clsP_paramext_val> results) {
        items = results;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.lbl1.setText(""+items.get(position).id_paramext);
        holder.lbl2.setText(""+items.get(position).valor_predet);
