...
public class LA_List extends BaseAdapter {
    ...
    public LA_List(Context context, PBase owner, ArrayList<clsClasses.clsList> results) {
        items = results;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = l_Inflater.inflate(R.layout.lv_list, null);
